            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    _HeroCard(onAnalyze: () => onNavigate(2)),
  ...
  Widget build(BuildContext context) {
    final items = [
      _QuickItem(emoji: '📷', label: '새 분석', sub: '사진 올리기',
          bg: AppColors.primaryLight, fg: AppColors.primaryDark, tabIndex: 2),
      _QuickItem(emoji: '📋', label: '내 기록', sub: '이전 분석',
          bg: AppColors.secondaryLight, fg: const Color(0xFF2A9060), tabIndex: 1),
